...
switch ($_GET["op"]) {
	...
	if (empty($idusuario)) {
		$rspta=$usuario->insertar($nombre,$tipo_documento,$num_documento,$direccion,$telefono,$email,$cargo,$login,$clavehash,$imagen,$_POST['permisos']);
		echo $rspta ? "Datos registrados correctamente" : "No se pudo registrar todos los datos del usuario";
	}else{
		$rspta=$usuario->editar($idusuario,$nombre,$tipo_documento,$num_documento,$direccion,$telefono,$email,$cargo,$login,$clavehash,$imagen,$_POST['permisos']);
...
//almacenar permisos asigandos
	...
	if (isset($fetch)) {
		...
		in_array(5, $valores)?$_SESSION['pedidos']=1:$_SESSION['pedidos']=0;
		in_array(5, $valores)?$_SESSION['cuentas']=1:$_SESSION['cuentas']=0;
		in_array(5, $valores)?$_SESSION['modelos']=1:$_SESSION['modelos']=0;
		in_array(5, $valores)?$_SESSION['acceso']=1:$_SESSION['acceso']=0;
		in_array(6, $valores)?$_SESSION['consultac']=1:$_SESSION['consultac']=0;
		in_array(7, $valores)?$_SESSION['consultav']=1:$_SESSION['consultav']=0;
		in_array(8, $valores)?$_SESSION['historialDePrecio']=1:$_SESSION['historialDePrecio']=0;
