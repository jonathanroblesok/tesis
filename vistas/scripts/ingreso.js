...
function listarInsumos(){
	tabla=$('#tblinsumos').dataTable({
		...
		"ajax":
		{
			url:'../ajax/ingreso.php?op=listarInsumos',
			type: "get",
			dataType : "json",
			error:function(e){
				console.log(e.responseText);
...
function agregarDetalle(idinsumo,insumo,stock,precio_compra){
	var cantidad=1;
	var precio_compra=0;
	console.log(stock);
        ...
        '<td><input type="number" min="1" name="cantidad[]" id="cantidad[]" value="'+cantidad+'"></td>'+
