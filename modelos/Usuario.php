...
public function insertar($nombre,$tipo_documento,$num_documento,$direccion,$telefono,$email,$cargo,$login,$clave,$imagen,$permisos){
	$sql="INSERT INTO usuarios (nombre,tipo_documento,num_documento,direccion,telefono,email,cargo,login,clave,imagen,condicion) VALUES ('$nombre','$tipo_documento','$num_documento','$direccion','$telefono','$email','$cargo','$login','$clave','$imagen','1')";
	//return ejecutarConsulta($sql);
	 ...
	 while ($num_elementos < count($permisos)) {
	 	...
	 	$sql_detalle="INSERT INTO usuario_permisos (usuario_id,permiso_id) VALUES('$idusuarionew','$permisos[$num_elementos]')";
...
public function editar($idusuario,$nombre,$tipo_documento,$num_documento,$direccion,$telefono,$email,$cargo,$login,$clave,$imagen,$permisos){
	...
	WHERE idusuario='$idusuario'";
	 ...
	 while ($num_elementos < count($permisos)) {
	 	...
	 	$sql_detalle="INSERT INTO usuario_permisos (usuario_id,permiso_id) VALUES('$idusuario','$permisos[$num_elementos]')";
...
public function listarmarcados($idusuario){
	$sql="SELECT * FROM usuario_permisos WHERE usuario_id='$idusuario'";
	return ejecutarConsulta($sql);
}
