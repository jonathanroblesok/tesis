...
$empresa="EYG Confecciones";
$documento="40486665";
$direccion="";
$telefono="3704816025";
$email="eygconfecciones@gmail.com";
	 ?>
<div class="zona_impresion">
	...
	<table border="0" align="center" width="300px">
		...
		<tr>
			...
			<td>Cliente: <?php echo $reg->cliente.":".$reg->nombre." ".$reg->apellido; ?>
			</td>
		</tr>
		<tr>
			<td>
				<?php echo $reg->tipo_documento_id.":,,,,,, ".$reg->num_documento; ?>
			</td>
		</tr>
		<tr>
			<td>
	...
	<table border="0" align="center" width="300px">
		...
		<tr>
			<td colspan="3" align="center">EYG Confecciones</td>
		</tr>
		<tr>
